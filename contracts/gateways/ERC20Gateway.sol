...
//  */
// contract ERC20Gateway is Initializable, UUPSUpgradeable, Ownable2StepUpgradeable, ReentrancyGuardUpgradeable, IGateway {
...
//             $.otherSide,
//             abi.encodeCall(УК.receiveNativeTokens, (msg.sender, _to, _amount))
//         );
//     }
