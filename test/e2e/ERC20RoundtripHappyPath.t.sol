...
contract ERC20RoundtripHappyPathTest is BaseDualFork {
    ...
    function test_e2e_erc20Roundtrip_happyPath_dualFork_daOn() public {
        ...
        Rollup.BlockCommitment memory batch1Commitment = _buildCommitment(MOCK_GENESIS_HASH, batch1BlockHash, l2ToL1.messageHash, ZERO_HASH);
        ...
        Rollup.BlockCommitment memory batch2Commitment = _buildCommitment(batch1Commitment.blockHash, batch2BlockHash, ZERO_HASH, depositHash);
