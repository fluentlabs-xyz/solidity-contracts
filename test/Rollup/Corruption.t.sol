...
contract CorruptionTest is RollupAssertions {
    ...
    function test_corrupt_daDeadlineExceeded() public {
        Rollup r = _deployRollupWithConfig(50, uint64(MAX_DEPOSITS_PER_BATCH));
    ...
    function test_corrupt_daDeadlineDisabled_zeroMeansDisabled() public {
        Rollup r = _deployRollupWithConfig(0, uint64(MAX_DEPOSITS_PER_BATCH));
    ...
    function _deployRollupWithConfig(uint64 daDeadline, uint64 maxDepositsPerBatch) private returns (Rollup) {
