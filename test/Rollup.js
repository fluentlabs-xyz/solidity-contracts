...
describe("Rollup.sol", function () {
    ...
    before(async function () {
        ...
        rollup = await RollupContract.deploy(accounts[0], 10000, 0, 1, verifier.target, vkKey, genesisHash, bridge.target, 2, 10, 1000);
    ...
    it("Accept and prove block commitment", async function () {
        ...
        await rollupContractWithSigner.challengeBlockCommitment(batchIndex, commitmentBatch[0], blockProof, { value: 10000 });
        ...
        const zkProof =
            "";

        await rollupContractWithSigner.proofBlockCommitment(batchIndex, commitmentBatch[0], zkProof, blockProof);
    ...
    it("Revert check with block commitments", async function () {
        ...
        const blockProof = generateMerkleProof(commitmentBatch, 0);
        await rollupContractWithSigner.challengeBlockCommitment(nextBatchIndex, commitmentBatch[0], blockProof, { value: 10000 });
