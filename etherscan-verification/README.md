...
| ---------------------------- | -------------------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| **ERC20PeggedToken** (impl)  | `0x5c96D66842687EB3e3d9b658c8E0636F78DE7F66` | `forge flatten contracts/tokens/ERC20PeggedToken.sol`     | None                                                                                                     |
| **MockERC20Token**           | `0xE09CAC803c4a99FB94C891f64663B5656b2F261d` | `forge flatten contracts/mocks/MockERC20.sol`             | `"Mock Deposit Token", "MDT", "1000000000000000000000000", "0x1C92DffBCe76670F69007F22A54e31ff3Ab45d5E"` |
| **ERC20TokenFactory** (impl) | `0x02fbb71ce3ae194029df08dc00b5dc974df01d4f` | `forge flatten contracts/factories/ERC20TokenFactory.sol` | None                                                                                                     |
| **FluentBridge** (impl)      | `0x09e3882a9d98967b8dfd007885530c8906e2aa0a` | Cyclic deps: use Standard JSON input for verification     | None                                                                                                     |
| **ERC20Gateway** (impl)      | `0x45cfcaeb9ef3876aa8dd9e7ae9098fe75c16c820` | Cyclic deps: use Standard JSON input for verification     | None                                                                                                     |
